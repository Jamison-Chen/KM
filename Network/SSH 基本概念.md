...
上方流程圖中，產生 shared secret key 的演算法叫做 [Diffie-Hellman Key Exchange Algorithm](</Cryptography/Diffie-Hellman Key Exchange Algorithm.md>)，client 與 server 不用將 secret key 傳給對方就可以得到一模一樣的 secret key。
