...
比如進行 [tuple unpacking](</Programming Language/Python/零碎筆記.md#Tuple Unpacking>) 時，若其中有些不重要的資料，你可以這麼做：
...
### 一、["類" Private attribute/method](</Programming Language/Python/Python 中的 OOP (1).md#"類" Private attribute/method>)
