...
- [Shell](</Operating System/Shell/L1 - Introduction.md>)（殼層）是一個 OS 的最外層，是一種應用程式，使用者必須透過 shell 與 OS 互動
...
- Shell 可以轉譯並執行 [L2 - Shell Script Overview](</Operating System/Shell/L2 - Shell Script Overview.md>)（一種程式語言）
