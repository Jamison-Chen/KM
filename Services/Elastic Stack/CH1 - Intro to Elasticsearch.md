...
- 使用 [[HTTP2 vs. HTTP1.1]] 做為 application layer，並且使用 [REST API](</Web Development/REST API.md>)（詳見[此段](</./Services/Elastic Stack/CH1 - Intro to Elasticsearch.md#溝通方式>)）
...
Elasticsearch 透過 [[HTTP2 vs. HTTP1.1]] 傳送，且使用的是 [REST API](</Web Development/REST API.md>)，預設使用 port 9200。
